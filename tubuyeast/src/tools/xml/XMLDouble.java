...
/**
 * An <code>XMLMappable</code> wrapper around the <code>double</code> primitive.
 * 
 * @author tedmunds
 */
public class XMLDouble implements XMLMappable
{
    ...
    /**
     * Constructs an <code>XMLDouble</code> with no contents, ready to be loaded
     * from an XML node.
     * 
     */
    public XMLDouble()
    ...
    /**
     * Constructs an <code>XMLDouble</code> with the specified contents, ready
     * to be exported into an XML node.
     * 
     * @param contents the underlying primitive contents
     */
    public XMLDouble(double contents)
    {
        super();
    ...
    public void loadFromXML(Node dataNode) throws XMLException
    {
        switch (dataNode.getNodeType())
        {
            ...
            case Node.TEXT_NODE :
                ...
                try
                {
                    this.contents = Double.parseDouble(numberString);
                }
    ...
    public void exportAsXML(Node exportNode) throws XMLException
    {
        switch (exportNode.getNodeType())
        {
            ...
            case Node.CDATA_SECTION_NODE :
            case Node.TEXT_NODE :
                exportNode.setNodeValue(Double.toString(contents));
                break;
            case Node.ELEMENT_NODE:
